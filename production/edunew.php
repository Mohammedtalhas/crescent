            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" action="edunew.php" method="POST" data-parsley-validate class="form-horizontal form-label-left">
						...
						<div class="form-group">
                        <div class="col"><label style="margin-left:35px"><strong>First Name:&nbsp;</strong></label>
						<input type="text" name="First_Name" style="padding-bottom:6px;width:175px;">
					...
					<div class="form-group">
                        <div class="col"><label style="margin-left:25px"><strong>Father Name:&nbsp;</strong></label>
						<input type="text" name="Father_name" style="padding-bottom:6px;width:175px;">
						<label style="padding-left:75px;"><strong>Mobile No.:&nbsp;</strong></label>
